<template>
  <div class="vt-wrap__footer vt-clearfix">
    <div v-if="perPageDropdownEnabled" class="footer__row-count vt-pull-left">
      <form>
    ...
    <div class="footer__navigation vt-pull-right">
...
<script>
import VtPaginationPageInfo from './VtPaginationPageInfo.vue';
import {
  PAGINATION_MODES,
...
export default {
  ...
  components: {
    'pagination-page-info': VtPaginationPageInfo,
  },
};
</script>
